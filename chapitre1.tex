...
Les approches de développement logiciel se divisent en méthodes classiques, basées sur une planification rigide et une forte documentation, et en méthodes agiles, privilégiant la flexibilité, la collaboration et l’adaptation continue. La figure \ref{fig:classique_vs_agile} illustre cette différence : 
\begin{figure}[H]
\centering
...
\end{figure} 
\newpage 
\subsection{Comparaison entre les méthodes agiles}

Après une comparaison des méthodes classiques et agiles, nous avons choisi une approche agile pour sa flexibilité. Une comparaison entre Scrum, Kanban et XP a ensuite été réalisée afin de sélectionner la méthode la plus adaptée à notre projet, comme présenté dans la table \ref{tab:comparaisonAgile}.

\begin{longtable}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}

\caption{Comparaison des méthodes agiles\cite{agile_comparatif_artza}}
\label{tab:comparaisonAgile} \\
\hline
...
La figure \ref{fig:chronogramme} présente les différentes étapes de réalisation de notre projet, planifiées sur une période de stage de 4 mois, s’étendant du 1er février 2026 au 31 mai 2026.
